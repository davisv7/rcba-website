    ...
    <section id="resources" className="py-24 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {resourceCategories.map((category, index) => (
            <div key={index} className="relative">
              <Card 
                className="p-6 bg-card/50 backdrop-blur border-border/50 opacity-50 pointer-events-none"
        ...
        <div className="relative">
          <Card className="overflow-hidden bg-gradient-to-br from-muted/50 to-background border-border/50 opacity-50">
          ...
          <div className="absolute top-8 right-8 bg-muted text-muted-foreground text-sm font-semibold px-4 py-2 rounded-full z-10">
            Coming Soon
          </div>
        </div>
      </div>
